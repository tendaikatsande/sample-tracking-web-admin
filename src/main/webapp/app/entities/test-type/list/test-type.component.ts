...
export class TestTypeComponent implements OnInit {
  ...
  delete(testType: ITestType): void {
    const modalRef = this.modalService.open(TestTypeDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: ITestType[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
