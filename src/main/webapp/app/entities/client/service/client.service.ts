...
export class ClientService {
  ...
  protected convertDateFromClient(client: IClient): IClient {
    return Object.assign({}, client, {
      createdDate: client.createdDate?.isValid() ? client.createdDate.toJSON() : undefined,
      lastModifiedDate: client.lastModifiedDate?.isValid() ? client.lastModifiedDate.toJSON() : undefined,
    });
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((client: IClient) => {
        client.createdDate = client.createdDate ? dayjs(client.createdDate) : undefined;
        client.lastModifiedDate = client.lastModifiedDate ? dayjs(client.lastModifiedDate) : undefined;
      });
    }
    return res;
  }
